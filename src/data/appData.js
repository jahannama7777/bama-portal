...
export const allApps = [
  ...
  { id: 9, titleFa: 'ایمیل سازمانی', titleEn: 'Webmail Service', desc: 'سامانه ارسال و دریافت نامه‌های الکترونیکی', icon: 'Mail', url: 'http://192.200.0.9:443', href: 'http://webmail.bamaco.local:443', roles: ['USER', 'ADMIN'] },
